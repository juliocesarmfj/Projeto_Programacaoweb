    ...
    function calcularTotal() {
      ...
      document.getElementById('total-produto01').innerText = totalProduto01.toFixed(2);
      document.getElementById('total-produto02').innerText = totalProduto02.toFixed(2);
      document.getElementById('total-produto03').innerText = totalProduto03.toFixed(2);
